...
/** Data type of the schema field. */ var Type;
(function(Type) {
    /**
...
/** Controls whether prominent people (celebrities) generation is allowed. If used with personGeneration, personGeneration enum would take precedence. For instance, if ALLOW_NONE is set, all person generation would be blocked. If this field is unspecified, the default behavior is to allow prominent people. This enum is not supported in Gemini API. */ var ProminentPeople;
...
/** The harm category to be blocked. */ var HarmCategory;
...
/** The method for blocking content. If not specified, the default behavior is to use the probability score. This enum is not supported in Gemini API. */ var HarmBlockMethod;
...
/** The threshold for blocking content. If the harm probability exceeds this threshold, the content will be blocked. */ var HarmBlockThreshold;
...
/** Output only. The probability of harm for this category. */ var HarmProbability;
...
/** Output only. The severity of harm for this category. This enum is not supported in Gemini API. */ var HarmSeverity;
...
/** The status of the URL retrieval. */ var UrlRetrievalStatus;
...
/** The stage of the underlying model. This enum is not supported in Vertex AI. */ var ModelStage;
(function(ModelStage) {
    /**
...
/** Output only. The detail state of the tuning job (while the overall `JobState` is running). This enum is not supported in Gemini API. */ var TuningJobState;
...
/** Aggregation metric. This enum is not supported in Gemini API. */ var AggregationMetric;
...
/** Output only. Pairwise metric choice. This enum is not supported in Gemini API. */ var PairwiseChoice;
...
/** Output only. Current state of the `Document`. This enum is not supported in Vertex AI. */ var DocumentState;
...
/** The type of tool in the function call. */ var ToolType;
(function(ToolType) {
    /**
...
/** Resource scope. */ var ResourceScope;
...
/** Pricing and performance service tier. */ var ServiceTier;
...
/** Enum representing the Gemini Enterprise Agent Platform embedding API to use. */ var EmbeddingApiType;
...
/** Resize mode for the image input for video generation. */ var ImageResizeMode;
...
/** The type of the voice activity signal. */ var VoiceActivityType;
...
corresponding `ToolCall`. */ class ToolResponse {
}
...
/** The results from an evaluation run performed by the EvaluationService. This data type is not supported in Gemini API. */ class EvaluateDatasetResponse {
}
...
/** Response for the _register file method. */ class RegisterFilesResponse {
}
 ...
 */ function authConfigToMldev$4(fromObject) {
    const toObject = {};
    const fromApiKey = getValueByPath(fromObject, [
        'apiKey'
    ]);
    if (fromApiKey != null) {
        setValueByPath(toObject, [
...
function batchJobFromVertex(fromObject) {
    ...
    const fromOutputInfo = getValueByPath(fromObject, [
        'outputInfo'
    ]);
...
function generateContentConfigToMldev$1(apiClient, fromObject, parentObject) {
    ...
    const fromServiceTier = getValueByPath(fromObject, [
        'serviceTier'
    ]);
...
function generateContentResponseFromMldev$1(fromObject) {
    ...
    const fromModelStatus = getValueByPath(fromObject, [
        'modelStatus'
    ]);
...
function googleMapsToMldev$4(fromObject) {
    ...
    if (fromAuthConfig != null) {
        setValueByPath(toObject, [
            'authConfig'
        ], authConfigToMldev$4(fromAuthConfig));
    }
...
function googleSearchToMldev$4(fromObject) {
    const toObject = {};
    const fromSearchTypes = getValueByPath(fromObject, [
        'searchTypes'
    ]);
...
function partToMldev$4(fromObject) {
    ...
    const fromToolResponse = getValueByPath(fromObject, [
        'toolResponse'
    ]);
    ...
    const fromPartMetadata = getValueByPath(fromObject, [
        'partMetadata'
    ]);
...
function toolToMldev$4(fromObject) {
    ...
    const fromMcpServers = getValueByPath(fromObject, [
        'mcpServers'
    ]);
...
function googleMapsToMldev$3(fromObject) {
    ...
    if (fromAuthConfig != null) {
        setValueByPath(toObject, [
            'authConfig'
        ], authConfigToMldev$3(fromAuthConfig));
    }
    const fromEnableWidget = getValueByPath(fromObject, [
        'enableWidget'
    ]);
...
function internalRegisterFilesParametersToMldev(fromObject) {
    const toObject = {};
    const fromUris = getValueByPath(fromObject, [
        'uris'
    ]);
    if (fromUris != null) {
        setValueByPath(toObject, [
...
function googleMapsToMldev$2(fromObject) {
    ...
    if (fromAuthConfig != null) {
        setValueByPath(toObject, [
            'authConfig'
        ], authConfigToMldev$2(fromAuthConfig));
    }
    const fromEnableWidget = getValueByPath(fromObject, [
        'enableWidget'
    ]);
...
function liveConnectConfigToMldev$1(fromObject, parentObject) {
    ...
    if (parentObject !== undefined && fromInputAudioTranscription != null) {
        setValueByPath(parentObject, [
            'setup',
            'inputAudioTranscription'
        ], audioTranscriptionConfigToMldev$1(fromInputAudioTranscription));
    }
    ...
    if (parentObject !== undefined && fromOutputAudioTranscription != null) {
        setValueByPath(parentObject, [
            'setup',
            'outputAudioTranscription'
        ], audioTranscriptionConfigToMldev$1(fromOutputAudioTranscription));
    }
    ...
    const fromAvatarConfig = getValueByPath(fromObject, [
        'avatarConfig'
    ]);
...
function voiceActivityFromVertex(fromObject) {
    const toObject = {};
    const fromVoiceActivityType = getValueByPath(fromObject, [
        'type'
    ]);
...
function embedContentConfigToVertex(fromObject, parentObject, rootObject) {
    ...
    if (discriminatorDocumentOcr === 'EMBED_CONTENT') {
        const fromDocumentOcr = getValueByPath(fromObject, [
            'documentOcr'
        ]);
...
function embedContentParametersPrivateToVertex(apiClient, fromObject, rootObject) {
    ...
    if (discriminatorContent === 'EMBED_CONTENT') {
        ...
        if (fromContent != null) {
            setValueByPath(toObject, [
                'content'
            ], contentToVertex(tContent(fromContent)));
        }
    }
    const fromConfig = getValueByPath(fromObject, [
        'config'
...
function embedContentResponseFromVertex(fromObject, rootObject) {
    ...
    if (rootObject && getValueByPath(rootObject, [
        'embeddingApiType'
    ]) === 'EMBED_CONTENT') {
        const embedding = getValueByPath(fromObject, [
            'embedding'
        ]);
        const usageMetadata = getValueByPath(fromObject, [
            'usageMetadata'
        ]);
        const truncated = getValueByPath(fromObject, [
            'truncated'
        ]);
        if (embedding) {
            const stats = {};
...
function generateVideosConfigToVertex(fromObject, parentObject, rootObject) {
    ...
    const fromResizeMode = getValueByPath(fromObject, [
        'resizeMode'
    ]);
...
function googleMapsToMldev$1(fromObject, rootObject) {
    ...
    if (fromAuthConfig != null) {
        setValueByPath(toObject, [
            'authConfig'
        ], authConfigToMldev$1(fromAuthConfig));
    }
    const fromEnableWidget = getValueByPath(fromObject, [
        'enableWidget'
    ]);
 ...
 */ function createFileSearchStoreConfigToMldev(apiClient, fromObject, parentObject) {
    ...
    if (parentObject !== undefined && fromEmbeddingModel != null) {
        setValueByPath(parentObject, [
            'embeddingModel'
        ], tModel(apiClient, fromEmbeddingModel));
    }
    return toObject;
}
...
const MULTI_REGIONAL_LOCATIONS = new Set([
    'us',
    'eu'
]);
 ...
 */ class ApiClient {
    ...
    async apiCall(url, requestInit) {
        ...
        const runFetch = async ()=>{
            ...
            throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p$2d$retry$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["AbortError"](`Non-retryable exception ${response.statusText} sending request`);
        };
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$p$2d$retry$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"])(runFetch, {
 ...
 */ class BaseWebhooks extends APIResource {
     ...
     */ update(id, params = {}, options) {
        const _a = params !== null && params !== void 0 ? params : {}, { api_version = this._client.apiVersion, update_mask } = _a, body = __rest(_a, [
            "api_version",
            "update_mask"
        ]);
     ...
     * Lists all Webhooks.
     */ list(params = {}, options) {
        const _a = params !== null && params !== void 0 ? params : {}, { api_version = this._client.apiVersion } = _a, query = __rest(_a, [
            "api_version"
        ]);
        return this._client.get(path`/${api_version}/webhooks`, Object.assign({
            query
        }, options));
    }
    /**
     ...
     */ ping(id, params = undefined, options) {
        ...
        return this._client.post(path`/${api_version}/webhooks/${id}:ping`, Object.assign({
            body: body
        }, options));
    }
    /**
     ...
     */ rotateSigningSecret(id, params = {}, options) {
        const _a = params !== null && params !== void 0 ? params : {}, { api_version = this._client.apiVersion } = _a, body = __rest(_a, [
            "api_version"
        ]);
        return this._client.post(path`/${api_version}/webhooks/${id}:rotateSigningSecret`, Object.assign({
            body
        }, options));
    }
}
...
function createTuningJobConfigToVertex(fromObject, parentObject, rootObject) {
    ...
    if (discriminatorTuningMode === 'SUPERVISED_FINE_TUNING') {
        const fromTuningMode = getValueByPath(fromObject, [
            'tuningMode'
        ]);
...
function resolveCloudFlag(options) {
    ...
    if (options.enterprise !== undefined || options.vertexai !== undefined) {
        if (options.enterprise !== undefined && options.vertexai !== undefined && options.enterprise !== options.vertexai) {
    ...
    if (envEnterpriseStr !== undefined && envVertexaiStr !== undefined && useEnterpriseEnv !== useVertexaiEnv) {
...
//# sourceMappingURL=node_modules_%40google_genai_dist_node_index_mjs_029rwj6._.js.map